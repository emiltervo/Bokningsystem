...
public class RecipeView {
    ...
    private void createMainContent() {
        ...
        JLabel test = new JLabel("ENTER PERSONAL NUMBER TO RETRIEVE JOURNAL");
        ...
        grayPanel.add(userInputField);

        // Add action listener to the button
        submitButton.addActionListener(e -> {
            long userInput = Long.parseLong(userInputField.getText());
            Recipe recipe = RecipeRepository.getRecipeByUserID(userInput);
            if (recipe != null) {
                JOptionPane.showMessageDialog(frame,"Recipe FOUND!\n" + recipe.toString());
            } else {
